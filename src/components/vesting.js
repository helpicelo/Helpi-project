...
class Vesting extends Component {
  ...
  render() {
    ...
    if(this.state.currentTime - this.state.time <= 259200 ){
        alert = <button type="button" class="btn btn-danger btn-lg btn-block">TOKENS CAN BE UNLOCKED EVERY 72 HOURS</button>
    }else{
          ...
          <div className="row">
            <main role="main" className="col-lg-12 ml-auto mr-auto" style={{ maxWidth: '600px' }}>
              ...
              <div class="d-grid">
               ...
               {content}
               {alert}
               <button type="button" class="btn btn-outline-default btn-sm btn-block">
